...
export default function ProductDetailsScreen({ route, navigation }) {
  ...
  const [item, setItem] = useState({
    ...
    title: post.title,
    price: post.price,
    isDiscounted: true, // TODO: Replace with `post.isDiscounted` when endpoint implemented,
    prevPrice: 30.0, // TODO: Replace with `post.prevPrice` when endpoint implemented,
